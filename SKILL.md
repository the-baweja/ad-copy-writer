...
- **The hook(s)** â What scroll-stopping opener(s) will this copy build from? If the user provided hooks, use them. If not, write 3-5 working hooks (but note in the output that the dedicated Ad Hook Generator would produce a more comprehensive library).
- **The product** â What it is, price point, hero claims, key differentiator. Be specific: "$49/month" not "affordable," "clinically tested on 2,400 people" not "clinically tested."
- **The audience** â Who they are, what life moment makes them a buyer, what they've already tried, what they believe about this category.
- **The offer** â What exactly does the ad promise? Free trial? Discount? Free shipping? Bundle? The offer is NOT the product â it's the deal structure.
- **The landing page** â Where does the click go? What does the page say? What's the conversion action on the page (purchase, sign-up, book a call)? If a URL is provided, visit it.
- **The funnel stage** â Cold (never heard of the brand), warm (aware but unconverted), hot (retargeting / cart abandoners).

**Why this step matters for what comes next:** The brief is the foundation. Body copy that doesn't match the hook feels disjointed. Copy that doesn't match the offer feels deceptive. Copy that doesn't match the landing page kills post-click conversion. Every element must align â and this step ensures alignment before a single word of copy is written.
...
This step is what separates copy that gets clicks from copy that gets skipped. You're not researching the product â you did that in Step 1. You're researching the DECISION.

**Research these conversion drivers:**

- **Why people buy** â Search reviews, Reddit, social comments for purchase triggers. What was the tipping point? "I finally bought it because..." is gold.
- **Why people DON'T buy** â Search for objections, complaints, hesitations. "I almost bought it but..." reveals every barrier your copy needs to overcome.
- **What proof converts** â Which types of evidence does this audience trust? Clinical studies? User-generated before/afters? Celebrity endorsements? Volume metrics ("50,000+ sold")? The proof type that resonates varies dramatically by category and audience.
- **Price sensitivity** â Is price an objection? If so, what reframing works? (Cost per day, comparison to alternatives, ROI framing)
- **Competitor positioning** â What are competitors saying in their ad copy? What claims are oversaturated? What's nobody saying?
...
- **PAS (Problem-Agitate-Solution)** â When the primary objection is "I don't think my problem is serious enough." Agitation makes the pain feel urgent. Best for cold traffic with a clear problem.
- **Storytelling** â When the purchase trigger is "I saw someone like me succeed." First-person narrative builds identification. Best for warm traffic and lifestyle products.
- **Educational** â When the objection is "I don't understand why this is different." Teaching builds authority and trust. Best for technical or complex products.
- **Social Proof Stack** â When the trust signal is volume or authority. Stack proof points: numbers, names, credentials. Best for established brands with data.
- **UGC-style** â When the audience trusts peers over brands. Casual, unpolished, feels like a text message. Best for younger demographics and DTC.
- **Premium/Brand** â When the purchase trigger is aspiration or status. Minimal, confident, every word earns its place. Best for luxury and premium positioning.
- **Comparison** â When the primary objection is "why not just use [competitor]?" Direct side-by-side or indirect positioning. Best for challenger brands.
- **Urgency/Scarcity** â When the decision timeline is long ("took me 3 months to try"). Creates a reason to act NOW. Best for hot traffic and limited offers.
...
- **Benefit-forward CTA** â "See how 12,000 women cleared their skin in 30 days â" â tells them what they GET by clicking
- **Curiosity CTA** â "The full ingredient breakdown is on the page â" â creates an information gap that only clicking resolves
- **Risk-reversal CTA** â "Try it free for 30 days â cancel anytime â" â removes the barrier to clicking
- **Social proof CTA** â "Join 50,000+ customers who switched this month â" â clicking becomes joining a movement
- **Specificity CTA** â "See the 3-step routine that works for oily skin â" â ultra-specific promise that matches their exact situation
- **Urgency CTA** â "This week only â 40% off your first order â" â time-bound reason to act now
- **Challenge CTA** â "Take the 14-day challenge â results or your money back â" â frames clicking as accepting a challenge
- **Education CTA** â "Watch the 2-minute breakdown â" â low-commitment ask that feels like learning, not buying
...
1. **Hook-to-Body Flow** â Does the body deliver on the hook's promise? (1 = disconnected, 5 = seamless)
2. **Proof Strength** â How compelling is the evidence? (1 = no proof, 5 = undeniable)
3. **Objection Handling** â Does the copy address why people DON'T buy? (1 = ignores objections, 5 = dissolves them)
...
- 2.5-3.4 = Predicted CTR: 1.0-2.0% (Solid â second batch)
- Below 2.5 = Predicted CTR: under 1.0% (Weak â rework or cut)
